...
const FeaturedRestaurants = () => {
  ...
  const restaurants = [
    ...
    },
    {
      ...
      distance: "2.5 km",
      image: "/api/placeholder/300/200",
      description: "Traditional Indian dishes with aromatic spices and fresh ingredients."
    },
    {
      id: 3,
      name: "Burger Palace",
    ...
    },
    {
      ...
      distance: "1.5 km",
      image: "/api/placeholder/300/200",
      description: "Organic, healthy meals with fresh locally-sourced ingredients."
    },
    {
      id: 6,
      name: "Taco Fiesta",
      ...
      distance: "2.1 km",
      image: "/api/placeholder/300/200",
      description: "Authentic Mexican tacos with homemade sauces and fresh toppings."
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Discover our most popular restaurants offering great food and service
          </p>
        </div>

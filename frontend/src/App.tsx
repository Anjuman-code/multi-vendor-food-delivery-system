...
const GoogleAuthCallbackPage = lazy(
  () => import('./pages/auth/GoogleAuthCallbackPage'),
);
...
const CreateTicketPage = lazy(
  () => import('./pages/customer/CreateTicketPage'),
);
const TicketDetailPage = lazy(
  () => import('./pages/customer/TicketDetailPage'),
);
...
const MenuItemEditorPage = lazy(
  () => import('./pages/vendor/MenuItemEditorPage'),
);
...
const VendorCustomersPage = lazy(
  () => import('./pages/vendor/VendorCustomersPage'),
);
const VendorSettingsPage = lazy(
  () => import('./pages/vendor/VendorSettingsPage'),
);
const VendorSupportPage = lazy(
  () => import('./pages/vendor/VendorSupportPage'),
);
const VendorCreateTicketPage = lazy(
  () => import('./pages/vendor/VendorCreateTicketPage'),
);
const VendorTicketDetailPage = lazy(
  () => import('./pages/vendor/VendorTicketDetailPage'),
);
const VendorOnboardingPage = lazy(
  () => import('./pages/vendor/VendorOnboardingPage'),
);

// ── Rider pages ────────────────────────────────────────────────
const RiderLayout = lazy(() => import('./layouts/RiderLayout'));
const RiderDashboardPage = lazy(
  () => import('./pages/rider/RiderDashboardPage'),
);
const AvailableDeliveriesPage = lazy(
  () => import('./pages/rider/AvailableDeliveriesPage'),
);
const ActiveDeliveryPage = lazy(
  () => import('./pages/rider/ActiveDeliveryPage'),
);
...
const RiderCreateTicketPage = lazy(
  () => import('./pages/rider/RiderCreateTicketPage'),
);
const RiderTicketDetailPage = lazy(
  () => import('./pages/rider/RiderTicketDetailPage'),
);
const RiderOnboardingPage = lazy(
  () => import('./pages/rider/RiderOnboardingPage'),
);
...
const AdminCustomersPage = lazy(
  () => import('./pages/admin/users/CustomersPage'),
);
const AdminCustomerDetailPage = lazy(
  () => import('./pages/admin/users/CustomerDetailPage'),
);
const AdminVendorsPage = lazy(() => import('./pages/admin/users/VendorsPage'));
const AdminVendorDetailPage = lazy(
  () => import('./pages/admin/users/VendorDetailPage'),
);
const AdminDriversPage = lazy(() => import('./pages/admin/users/DriversPage'));
const AdminDriverDetailPage = lazy(
  () => import('./pages/admin/users/DriverDetailPage'),
);
const AdminRestaurantsPage = lazy(
  () => import('./pages/admin/restaurants/RestaurantsPage'),
);
const AdminApprovalQueuePage = lazy(
  () => import('./pages/admin/restaurants/ApprovalQueuePage'),
);
const AdminRestaurantDetailPage = lazy(
  () => import('./pages/admin/restaurants/RestaurantDetailPage'),
);
...
const AdminPayoutsPage = lazy(
  () => import('./pages/admin/finance/PayoutsPage'),
);
const AdminRevenueReportsPage = lazy(
  () => import('./pages/admin/finance/RevenueReportsPage'),
);
const AdminSupportPage = lazy(
  () => import('./pages/admin/support/SupportPage'),
);
const AdminTicketDetailPage = lazy(
  () => import('./pages/admin/support/AdminTicketDetailPage'),
);
const AdminDisputePage = lazy(
  () => import('./pages/admin/support/DisputePage'),
);
const AdminReviewModerationPage = lazy(
  () => import('./pages/admin/support/ReviewModerationPage'),
);
const AdminTaxonomyPage = lazy(
  () => import('./pages/admin/content/TaxonomyPage'),
);
const AdminContentBlocksPage = lazy(
  () => import('./pages/admin/content/ContentBlocksPage'),
);
const AdminAuditLogPage = lazy(
  () => import('./pages/admin/system/AuditLogPage'),
);

...
const QUICK_ACTIONS = [
  {
    ...
    description: "Problem with a delivery",
    icon: Bike,
  ...
  },
  {
    ...
    description: "Issues with earnings or payments",
    icon: CreditCard,
  ...
  },
  {
    ...
    label: "Account Issue",
    description: "Problems with your rider account",
    icon: User,
        ...
        <div className="mb-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            {QUICK_ACTIONS.map((action, idx) => (
              ...
              >
                <Link to={`/rider/support/new?type=${action.type}`}>
        ...
        <div>
          ...
          {loading ? (
            ...
            <Card className="p-10 text-center">
              ...
              <Button asChild className="bg-orange-500 hover:bg-orange-600">
                <Link to="/rider/support/new">Create your first ticket</Link>
              </Button>
            </Card>
          ) : (
            <div className="space-y-2">
              {tickets.map((ticket, idx) => (
                ...
                >
                  <Link to={`/rider/support/${ticket._id}`}>

...
const TermsPage: React.FC = () => (
  <LegalPage
    ...
    intro="Please read these terms carefully before using the Food Rush food delivery platform. By using our services, you agree to be bound by these terms."
    ...
    cta={{
      ...
      body: "If you have any questions or concerns about these Terms and Conditions, please don't hesitate to reach out to our support team.",
      primary: { label: "Contact Us", to: "/contact" },
      secondary: { label: "View Privacy Policy", to: "/privacy" },
    }}
  />
);
